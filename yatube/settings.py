...
#перечень адресов, с которых серверу разрешено принимать запросы. В этом списке есть и специальный адрес тестового сервера.
ALLOWED_HOSTS = [
        "localhost",
        "127.0.0.1",
        "[::1]",
...
# Мультисайтовость нам не понадобится, так что укажем в настройках ID текущего сайта и забудем об этом
SITE_ID = 1
